...
//	MSProc.MSSegmentation(Img);
	...
	// Преобразование результата Mean Shift в оттенки серого
	Mat gray;
	cvtColor(Img, gray, COLOR_BGR2GRAY);

	// Применение алгоритма Canny для нахождения границ
	Mat edges;
	...
	// Рисование контуров и определение цветов
